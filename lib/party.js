...
import { appendOptOutInstructions } from "@/lib/sms";
...
export function buildSmsReply(now = new Date()) {
  ...
  return appendOptOutInstructions(
    `The next party is at ${party.location} on ${party.dateLabel}. It starts at sunset ${party.sunsetLabel}.`,
  );
}
